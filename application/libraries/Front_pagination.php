...
class Front_pagination{  
	...
	var $next_link			= '<img src="../assets/images/next.gif" alt="Next Page" border="0" />';
	var $prev_link			= '<img src="../assets/images/previous.gif" alt="Previous Page" border="0" />';
	var $last_link			= 'Last &rsaquo;';
	var $uri_segment		= 4;
	var $full_tag_open		= '<p class="paging fl">';  
	var $full_tag_close		= '</p>';
	var $first_tag_open		= '';
	var $first_tag_close	= '&nbsp;';
	var $last_tag_open		= '&nbsp;';
	var $last_tag_close		= '';
	var $cur_tag_open		= '<a href="#" class="current">';
	var $cur_tag_close		= '</a>';
	var $next_tag_open		= '';
	var $next_tag_close		= '</a>';
	var $prev_tag_open		= '';
	var $prev_tag_close		= '</a>';
	var $num_tag_open		= '';
	var $num_tag_close		= '';
	...
	function create_links()
	{
        ...
        $curr_offset = $CI->uri->segment($this->uri_segment);
         ...
         $info = '<span class="tahoma b ft-11 black fl">Records :' . ( $curr_offset + 1 ) . ' to ' ;
	     //$info="";
...
//	$output .= '<a href="#" class="select">';
	...
	function getAJAXlink( $count, $text,$cls="") {
		...
		return "<a href=\"javascript:void(0);\"  class=\"$cls\"  onclick=\"$('".$this->table."').fadeTo(100,0.3,function(){
  																																					 ...
  																																					 $.post('". $this->base_url . $count ."', ". $this->additional_param .", function(data){
