        ...
        <div class="container">
			...
			<div class="col-md-12 ">
                    <div class="col-lg-12 topdashboardForm">
						<div class="col-lg-12">
                            <h2 class="element">
                                <img src="<?php echo theme_url();?>images/euro.png" />Earn While You Fly<img src="<?php echo theme_url();?>images/euro.png" />
                            </h2>
                        </div>
                            ...
                            <div id="home" class="tab-pane fade in active">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-5 col-xs-6 something">
			...
			<!--product listing start here -->
				 ...
				 <div class="partnerResult">
					...
					<div class="partnerInfo">
						<div class="partnerName"><?php echo $product_value['product_name']; ?> &nbsp;<em class="smallText">Added by</em>&nbsp;<a href="<?php echo base_url();?>home/timelinepost/<?php echo $product_value['user_id']; ?>"> <?php echo $product_value['first_name'] ;?></a> <br>
					 ...
					 <span class="show-read-more"> <?php echo $product_value['description'];?></span>
						...
						<div class="partnerSupport">
							 ...
							 <?php
								...
								<?php $userid= $product_value['user_id'] ;?>
                                            ...
                                            <li>
                                                <a href="#" target="_blank">
                                                    ...
                                                    <div class="item-info-container">
                                                        <h1>Sunny Is Traveling From  Lucas, Brazil</h1>
                                                        <p class="item-description" style="width: 250px;">

                                                            <img src="<?php echo theme_url();?>/images/email-icon.png" width="50" style="margin-left: -14px;" />Rahulkapoor@gmail.com<br />
                                                            <img src="<?php echo theme_url();?>/images/phone-icon.png" width="20" />&nbsp Call us  +91 852-707-1759
                                                        </p>
                                                    </div>
                                                </a>
                                            </li>
