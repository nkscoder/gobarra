<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
   ...
   <?php echo form_open_multipart("adminzone/country/uploads_country",'id="data_form"');?>
        ...
        <tbody>
          ...
          <tr>
            <td width="57%" style="text-align: center;"><br />
              ...
              <br />
              <br /></td>
            <td width="43%" style="text-align: center;"><a href="<?php echo base_url()?>assets/sample/sample.xls" style="color:#FF0000;">Download View Sample Excel File</a></td>
