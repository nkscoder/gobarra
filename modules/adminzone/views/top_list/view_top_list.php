<?php $this->load->view('includes/header'); ?>   
 ...
 <div class="box">
    <div class="heading">
      ...
      <div class="buttons"> <?php echo anchor("adminzone/top_list/edit/",'<span>Update Image</span>','class="button" ' );?> </div>
    </div>
    <div class="content">
		    <?php 
                if(error_message() !=''){
                ...
                ?> 	
		<?php echo form_open("adminzone/top_list/",'id="form" method="get" '); ?>
		...
		<tr>
			<td align="center" >Search [ Image Name ]
				...
				if($this->input->get_post('keyword')!=''){ 
					echo anchor("adminzone/top_list/",'<span>Clear Search</span>');
				} 
				?>
			</td>
		</tr>
		...
		{
			echo form_open("adminzone/top_list/",'id="myform"');
			?>
		...
		?> 
         ...
         <?php
		 $j=1;
		 $product_path = "top_list/".$pageVal['image'];
		?>
         ...
         <img src="<?php echo base_url().'uploaded_files/'.$product_path;?>"  /> </div>					
				...
				<td align="center" >  
                  <?php echo anchor("adminzone/top_list/edit/$pageVal[id]/".query_string(),'Update'); ?>         
