<?php $this->load->view('includes/header'); ?> 
 ...
 &raquo; <?php echo anchor('adminzone/mailcontents','Back To Listing'); ?> &raquo;  <?php echo $heading_title; ?>
      </div>
      <div class="box">
    <div class="heading">
	...
	<table width="90%"  class="tableList" align="center">
		...
		<tr class="trEven" valign="top">
			<td width="187" height="26">Mail Subject : <span class="required">*</span>  </td>
