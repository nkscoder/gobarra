              ...
              if($total_menu > 0)
              {
                  ...
                  if(is_array($value))
                  {
                    ...
                    <div style="float:left;">
				     <img src="'.base_url().'assets/adminzone/image/'.$icon.'" alt="" width="43" height="43" /></div>';				  
					     echo '<ul style="height:100px;  margin-top:5px; overflow-X:hidden; overflow:auto;">';
