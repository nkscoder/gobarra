 ...
 <div class="box">
    ...
    <div class="heading">
     ...
     <div class="content">
       ...
       <?php echo form_open_multipart('adminzone/candidate_file/add/');?>  
	...
	<table width="90%"  class="tableList" align="center">
		...
		<tr class="trOdd">
			...
			<td width="597"><input type="text" name="candidate_name" size="40" value="<?php echo set_value('candidate_name');?>"></td>
		</tr>
		<tr class="trOdd">
			<td width="253" height="26"> Candidate Email : <span class="required">*</span></td>
			<td width="597"><input type="text" name="email_id" size="40" value="<?php echo set_value('email_id');?>"></td>
		</tr>
		<tr class="trOdd">
			<td width="100" height="26"> Contact No. : <span class="required">*</span></td>
			<td width="597"><input type="text" name="contact" size="40" value="<?php echo set_value('contact'); ?>"></td>
		</tr>
		<tr class="trOdd">
			<td width="100" height="26"> Gender : <span class="required">*</span></td>
			<td width="50"><input type="checkbox" name="gender" size="40" value="male">Male
			<input type="checkbox" name="gender" size="40" value="female">Female</td>
		</tr>
		<tr class="trOdd">
			<td width="253" height="26"> Designation : <span class="required">*</span></td>
			<td width="597"><input type="text" name="designation" size="40" value="<?php echo set_value('designation');?>"></td>
		</tr>
		<tr class="trOdd">
			<td width="253" height="26"> Candidate Experience : <span class="required">*</span></td>
			<td width="597"><input type="text" name="experience" size="40" value="<?php echo set_value('experience');?>"></td>
		</tr>
		<tr class="trOdd">
			<td width="253" height="26"> Salary : <span class="required">*</span></td>
			<td width="597"><input type="text" name="salary" size="40" value="<?php echo set_value('salary');?>"></td>
		</tr>
		<!--<tr class="trOdd">
			<td width="253" height="26"> Current Educaton : <span class="required">*</span></td>
			<td width="597"><input type="text" name="current_education" size="40" value="<?php //echo set_value('current_education');?>"></td>
		</tr>-->
		<tr class="trOdd">
			<td width="253" height="26"> State : <span class="required">*</span></td>
			<td width="597"><input type="text" name="state" size="40" value="<?php echo set_value('state');?>"></td>
		</tr>
		<tr class="trOdd">
			<td width="253" height="26"> City : <span class="required">*</span></td>
			<td width="597"><input type="text" name="city" size="40" value="<?php echo set_value('city');?>"></td>
		</tr>
		<tr class="trOdd">
				<td width="253" height="26">Created Date : <span class="required">*</span></td>
				<td width="72%" align="left"><input name="created_date" class="start_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('created_date');?>"><a href="#" class="created_date"><img src="<?php echo base_url();?>assets/developers/images/cal0.png" width="16" height="16" alt=""></a>	 
        		</td>
		</tr>
		<tr class="trOdd">
				<td width="253" height="26"> Modified Date : <span class="required">*</span></td>
				<td width="72%" align="left">
				 <input name="modified_date" class="end_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('modified_date');?>"><a href="#" class="modified_date"><img src="<?php echo base_url();?>assets/developers/images/cal0.png" width="16" height="16" alt=""></a>
               </td>
		</tr>
		<tr class="trOdd">
			<td align="left">&nbsp;</td>
