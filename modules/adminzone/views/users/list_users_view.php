 ...
 <div class="box"> 
    <div class="heading">    
     ...
     <?php echo error_message(); ?>
      <?php 
	       echo form_open("adminzone/users/",'id="search_form" method="get" ');?>
             <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div>
			<table width="100%"  border="0" cellspacing="3" cellpadding="3" >
				<tr>
					<td align="center" >Search [ Users Name] 
					  <input type="text" name="keyword" value="<?php echo $this->input->get_post('keyword');?>"  />&nbsp;
					<a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a>
					 <?php if($this->input->get_post('keyword')!='')
					   {
					     echo anchor("adminzone/users/",'<span>Clear Search</span>');
					   }
					   ?>
					</td>
				</tr>
	 ...
	 <?php 
	  ...
	  {	 
	    echo form_open("adminzone/users/",'id="data_form"');?>
	  <table class="list" width="100%" id="my_data">     
        <thead>
          <tr>
			...
			<td width="73" class="center">Email</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['user_id'];?>" /></td>
           <td class="left"><?php echo $pageVal['first_name']."&nbsp;".$pageVal['last_name'];?></td>
