...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/adminzone/css/stylesheet.css" />
...
<div id="header">
  <div class="div1">
    ...
    <div class="div3">
    <img src="<?php echo base_url(); ?>assets/adminzone/image/lock.png" alt="" style="position: relative; top: 3px;" />&nbsp;
    
    <?php echo "You are logged in as administrator"; ?></div>
  ...
  <div id="menu">
   <ul class="left" style="display: none;"><?php createMenu($adminzone_menu_array);?></ul>
        
    <ul class="right" style="display: none;">     
      <li>  <?php echo anchor('adminzone/logout','Logout',array('class' => "top")); ?> </li>
    </ul>
    <?php
